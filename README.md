...
[![Build Status](https://travis-ci.org/10up/nodeifywp.svg?branch=master)](https://travis-ci.org/10up/nodeifywp) [![Support Level](https://img.shields.io/badge/support-stable-blue.svg)](#support-level)
